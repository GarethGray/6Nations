...
public class FixtureGenerator {
	...
	/**
	 * This method generates the fixtures for an entire tournament. It shuffles
	 * the teams to allow for randomly generated fixtures. Then it creates a
	 * Round of fixtures using createARound method. It adds this Round to an
	 * ArrayList of Rounds. It then moves the last Team in teams to the second
	 * place in the array and creates another Round. It repeats this until the
	 * given appropriate number of rounds (the number of teams minus 1) have
	 * been generated and added to roundList. Using this roundList the method
	 * then @returns a new Tournament
	 * 
	 * @param year
	 * @param teams
	 * @return Tournament
