...
public class Test_Round {
	...
	/**
	 * Test method for
	 * {@link uk.ac.qub.SixNationsProject.Round#Round(uk.ac.qub.SixNationsProject.Fixture, uk.ac.qub.SixNationsProject.Fixture, uk.ac.qub.SixNationsProject.Fixture, int)}.
	 */
	@Test
	...
	public void testPrintFixturesNotVoid() {
		...
		String expected = ("Round " + round.getNumber() + "\n" + "1. " + fixture1.getTeam1().getName() + " vs "
				+ fixture1.getTeam2().getName() + "\n" + "2. " + fixture2.getTeam1().getName() + " vs "
				+ fixture2.getTeam2().getName() + "\n" + "3. " + fixture3.getTeam1().getName() + " vs "
				+ fixture3.getTeam2().getName() + "\n" + " \n");
	...
	/**
	 * Testing the printFixtures method
	 */
	...
	/**
	 * Tests the setFixtures method in round to check the individual fixtures
	 * are correctly added to the ArrayList fixtures
	 */

	@Test
	public void testSetFixtures() {
		ArrayList<Fixture> expectedFixtures = new ArrayList<>();
		expectedFixtures.add(fixture1);
		expectedFixtures.add(fixture2);
		expectedFixtures.add(fixture3);

		Round round = new Round(fixture1, fixture2, fixture3, 1);

		round.setFixtures();

		assertEquals(round.getFixtures().get(0), expectedFixtures.get(0));
		assertEquals(round.getFixtures().get(1), expectedFixtures.get(1));
		assertEquals(round.getFixtures().get(2), expectedFixtures.get(2));
